    ...
    <div className="min-h-screen bg-white flex flex-col md:flex-row">
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-gray-50">
        ...
        >
          ...
          <p className="text-gray-500 mb-6">Sign in to manage your inventory and assets.</p>

          <div className="mb-8 p-4 bg-blue-50 rounded-2xl border border-blue-100">
            <h4 className="text-xs font-black text-blue-600 uppercase tracking-widest mb-2">Test Accounts</h4>
            <div className="space-y-2 text-xs">
              <p className="text-gray-600 flex justify-between">
                <span className="font-bold">Manager:</span>
                <span>manager@test.com / manager123</span>
              </p>
              <p className="text-gray-400 italic font-medium">To register as Admin, use your Google account.</p>
            </div>
          </div>
